...
class MemoryBank(nn.Module):
    ...
    def reload_memory_bank(self, backup_memory_bank: tuple):
        ...
        :return:
        """
        self.node_memories.data, self.node_last_updated_times.data, self.node_raw_messages.data = backup_memory_bank[0], backup_memory_bank[1], backup_memory_bank[2]
...
class MemoryUpdater(nn.Module):
    ...
    def update_memories(self, unique_node_ids: np.ndarray, unique_node_messages: torch.Tensor,
        ...
        self.memory_bank.node_last_updated_times[torch.from_numpy(unique_node_ids)] = unique_node_timestamps
    ...
    def get_updated_memories(self, unique_node_ids: np.ndarray, unique_node_messages: torch.Tensor,
        ...
        updated_node_last_updated_times[torch.from_numpy(unique_node_ids)] = unique_node_timestamps
